	...
	<c:forEach var="sc" items="${surveyContent }" begin="0" end="${survey.surCnt }" varStatus="status">
		...
		<div id="surveyResult">
	 		...
	 		<div>
			 	...
			 	<fmt:formatNumber value="${num1/totalCnt*100 }" pattern=".0" />%<input type="button" value="선택이유" onclick="viewDescription(${sc.SUR_SEQ}, ${sc.SURQ_SEQ}, 1)" style="float: right;" />
		 	</div>
	 		...
	 		<div>
			 	...
			 	<fmt:formatNumber value="${num2/totalCnt*100 }" pattern=".0" />%<input type="button" value="선택이유" onclick="viewDescription(${sc.SUR_SEQ}, ${sc.SURQ_SEQ}, 2)" style="float: right;" />
	 		</div>
	 		...
	 		<c:if test="${not empty sc.SURQ_TITLE3 }">
	 			<div>
			 		...
			 		<fmt:formatNumber value="${num3/totalCnt*100 }" pattern=".0" />%<input type="button" value="선택이유" onclick="viewDescription(${sc.SUR_SEQ}, ${sc.SURQ_SEQ}, 3)" style="float: right;" />
	 			</div>
	 		</c:if>
	 		...
	 		<c:if test="${not empty sc.SURQ_TITLE4 }">
	 			<div>
			 		...
			 		<fmt:formatNumber value="${num4/totalCnt*100 }" pattern=".0" />%<input type="button" value="선택이유" onclick="viewDescription(${sc.SUR_SEQ}, ${sc.SURQ_SEQ}, 4)" style="float: right;" />
	 			</div>
	 		</c:if>
	 		...
	 		<c:if test="${not empty sc.SURQ_TITLE5 }">
	 			<div>
			 		...
			 		<fmt:formatNumber value="${num5/totalCnt*100 }" pattern=".0" />%<input type="button" value="선택이유" onclick="viewDescription(${sc.SUR_SEQ}, ${sc.SURQ_SEQ}, 5)" style="float: right;" />
	 			</div>
	 		</c:if>
		</div>
		<hr><br>
